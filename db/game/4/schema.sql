...
--
-- Host: tbs-game-db.stoicstudio.com    Database: dev_qa
-- ------------------------------------------------------
...
CREATE TABLE `ranking` (
  ...
  `battle_wins` int(4) DEFAULT NULL,
  `battle_losses` int(4) DEFAULT NULL,
  `battle_elo` int(4) DEFAULT NULL,
  PRIMARY KEY (`account_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `session` (
  ...
  `session_date` bigint(8) NOT NULL,
  `display_name` varchar(128) NOT NULL,
  `keepalive_date` bigint(8) NOT NULL,
...
CREATE TABLE `unit_roster` (
  ...
  `stat_strength` int(4) DEFAULT NULL,
  `stat_armor` int(4) DEFAULT NULL,
  `stat_willpower` int(4) DEFAULT NULL,
  `stat_exertion` int(4) DEFAULT NULL,
  `stat_armor_break` int(4) DEFAULT NULL,
...
-- Dump completed on 2012-11-05  2:25:27
