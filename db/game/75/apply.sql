ALTER TABLE `ranking` CHANGE COLUMN `tourney_id` `tourney_id` INT(4) NOT NULL DEFAULT '0'  AFTER `account_id` 
, DROP PRIMARY KEY 
, ADD PRIMARY KEY (`account_id`, `tourney_id`) ;
